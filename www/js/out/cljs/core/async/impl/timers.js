...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15513 = (0);while(true){
if((i_15513 < arr.length))
{(arr[i_15513] = null);
{
var G__15514 = (i_15513 + (1));
i_15513 = G__15514;
continue;
}
} else
...
{var i_15520 = (self__.level + (1));while(true){
if((i_15520 <= (new_level + (1))))
{(update[i_15520] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15522 = (0);while(true){
if((i_15522 <= self__.level))
{var links_15523 = (update[i_15522]).forward;if(((links_15523[i_15522]) === x__$1))
{(links_15523[i_15522] = (x__$1.forward[i_15522]));
{
