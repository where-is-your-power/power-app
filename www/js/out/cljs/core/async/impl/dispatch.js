...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15593 = (0);while(true){
var m_15594 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15594 == null))
{} else
{m_15594.call(null);
if((count_15593 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15595 = (count_15593 + (1));
count_15593 = G__15595;
continue;
}
} else
{}
