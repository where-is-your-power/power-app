...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15599 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15599 = (function (val,box,meta15600){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15599.cljs$lang$type = true;
cljs.core.async.impl.channels.t15599.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15599";
cljs.core.async.impl.channels.t15599.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t15599");
});
cljs.core.async.impl.channels.t15599.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15599.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15601){var self__ = this;
var _15601__$1 = this;return self__.meta15600;
});
cljs.core.async.impl.channels.t15599.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15601,meta15600__$1){var self__ = this;
var _15601__$1 = this;return (new cljs.core.async.impl.channels.t15599(self__.val,self__.box,meta15600__$1));
});
cljs.core.async.impl.channels.__GT_t15599 = (function __GT_t15599(val__$1,box__$1,meta15600){return (new cljs.core.async.impl.channels.t15599(val__$1,box__$1,meta15600));
});
}
return (new cljs.core.async.impl.channels.t15599(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj15603 = {};return obj15603;
})();
...
{}
while(true){
var taker_15604 = self__.takes.pop();if((taker_15604 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15604))
{var take_cb_15605 = cljs.core.async.impl.protocols.commit.call(null,taker_15604);var val_15606 = (cljs.core.truth_((function (){var and__3628__auto__ = self__.buf;if(cljs.core.truth_(and__3628__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3628__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15605,val_15606,taker_15604,this$__$1){
return (function (){return take_cb_15605.call(null,val_15606);
});})(take_cb_15605,val_15606,taker_15604,this$__$1))
);
} else
{}
{
...
{} else
{var putter_15607 = self__.puts.pop();if((putter_15607 == null))
{} else
{var put_handler_15608 = putter_15607.handler;var val_15609 = putter_15607.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15608))
{var put_cb_15610 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15608);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15610,put_handler_15608,val_15609,putter_15607,_,retval,this$__$1){
return (function (){return put_cb_15610.call(null,true);
});})(put_cb_15610,put_handler_15608,val_15609,putter_15607,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_15609)))
...
{var taker_15611 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15611))
{var take_cb_15612 = cljs.core.async.impl.protocols.commit.call(null,taker_15611);var val_15613__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15612,val_15613__$1,taker_15611,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_15612.call(null,val_15613__$1);
});})(take_cb_15612,val_15613__$1,taker_15611,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_15614 = self__.puts.pop();if((putter_15614 == null))
{} else
{var put_handler_15615 = putter_15614.handler;var val_15616 = putter_15614.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15615))
{var put_cb_15617 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15615);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15617,put_handler_15615,val_15616,putter_15614,this$__$1){
return (function (){return put_cb_15617.call(null,true);
});})(put_cb_15617,put_handler_15615,val_15616,putter_15614,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__15622 = null;
var G__15622__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e15620){var t = e15620;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__15622__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e15621){var t = e15621;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__15622 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__15622__1.call(this,buf__$1);
case 2:
return G__15622__2.call(this,buf__$1,val);
}
